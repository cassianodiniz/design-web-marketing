...
This skill exists because the *expression* of an offer is handled elsewhere — `copywriting` writes the sales page, `cro` optimizes the conversion path, and pricing, launch timing, and packaging live in your broader go-to-market. None of that asks the deeper question: **is the offer underneath any of it actually good?**
...
### When pricing structure does more of the work
...
Skim this skill in those cases for the value equation framing, then focus on pricing structure (tiers, value metric, packaging).
